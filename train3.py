...
RUNS = 1000                      # number of simulations per node
SEEDS = [42, 45, 99, 70, 100]           # seeds to test stability
P_IC = 0.05
P_SIR = 0.05
...
summary_df.to_csv(f"{OUTDIR}/results_summary3.csv", index=False)

with open(f"{OUTDIR}/full_log_all_seeds3.txt", "w") as f:
